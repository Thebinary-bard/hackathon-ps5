...
import initialProfile from '../../data/company/companyProfile.json';
    ...
    useEffect(() => {
        const fetchProfile = async () => {
            try {
                ...
                if (data.success) {
                    // Merge backend data with initial mock structure for safety
                    setProfile({
                        ...initialProfile,
                        companyName: data.data.name || initialProfile.companyName,
                        companyType: data.data.title || initialProfile.companyType,
                        description: data.data.bio || initialProfile.description,
                    });
                }
            } catch (error) {
